...
class ProfileContainer extends React.Component {
    ...
    render() {
        const ProfileWithPreloader = withPreloader(Profile);
        return <ProfileWithPreloader {...this.props} /> //expand all the props from an object to separate attributes {...this.props}
    }
}
...
export default compose (connect(mapStateToProps, {getUserData}), withRouter)(ProfileContainer);