...
class ProfileContainer extends React.Component {
    ...
    render() {
        return <Profile {...this.props}/> //expand all the props from an object to seprate attributes {...this.props}
    }
}

const mapStateToProps = (state) => ({userData: state.profileData.userData});
