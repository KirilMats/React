...
const Users = (props) => {
    ...
    return (
        <div className={c.users}>
            {
                props.users.map( (u) => <User key={u.id} id={u.id} isFollowed={u.isFollowed} name={u.name} city={u.location.city} country={u.location.country} status={u.status} img_src={u.img_src} submitFollowing={props.submitFollowing} submitUnfollowing={props.submitUnfollowing} />)
            }
        </div>
    )
} 
